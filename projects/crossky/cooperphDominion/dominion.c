...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
	...
	z=z-1;
            ...
            playAdventurer(state, currentPlayer, handPos, temphand);
      return 0;
...
void playAdventurer(struct gameState *state, int currentPlayer, int handPos, int temphand[])
{
    int drawntreasure = 0;
    int z = 0;
